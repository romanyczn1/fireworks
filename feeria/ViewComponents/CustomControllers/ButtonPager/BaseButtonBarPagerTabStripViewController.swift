...
public struct ButtonBarPagerTabStripSettings {
    ...
    public struct Style {
        ...
        public var buttonBarShouldMaskToBounds = false
        public var buttonBarCornerRadius: CGFloat?
        ...
        public var buttonBarTopAndBottomContentInset: CGFloat?
...
class BaseButtonBarPagerTabStripViewController<ButtonBarCellType: UICollectionViewCell>: PagerTabStripViewController, PagerTabStripDataSource, PagerTabStripIsProgressiveDelegate, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    open override func viewDidLoad() {
        ...
        buttonBarView.layer.masksToBounds = settings.style.buttonBarShouldMaskToBounds
        buttonBarView.layer.cornerRadius = settings.style.buttonBarCornerRadius ?? buttonBarView.layer.cornerRadius
    ...
    @objc open func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAtIndexPath indexPath: IndexPath) -> CGSize {
        ...
        return CGSize(width: cellWidthValue, height: collectionView.frame.size.height - (settings.style.buttonBarTopAndBottomContentInset ?? 0))
    }
